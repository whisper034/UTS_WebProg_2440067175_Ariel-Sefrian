<main class="container">
    <div>
        <div class="d-flex mb-1">
            <div class="me-2" style="font-size: 16pt;">
                {{ $user->points }}
            </div>
            <img src="{{ asset('/images/logo/gold-star.png') }}" alt="gold star"
                 class="" style="width: 5%; object-fit: contain;">
        </div>
        ...
        <div class="redeem mb-4">
            <a class="text-white {{ $user->level }}-level-bg-color" href="#"
               style="padding: 0.5rem 2rem; text-decoration: none; border-radius: 40rem;">Redeem <img
